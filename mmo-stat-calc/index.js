...
function calculateStats() {
  ...
  window.localStorage.setItem('inputCache', JSON.stringify({ bootIndex, basePhysical, baseCritChance, baseCritDmg, gemSlots, critOnly }))
  ...
  const res = calcStats(equipments, basePhysical, baseCritChance, baseCritDmg, gemSlots, critOnly, 64).map(v => v.name())
