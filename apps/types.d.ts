import NBT from "../lib/nbtify/src/index.js";

export type NbtDataResult = Promise<{ name: string, data: Uint8Array }>;

export type PaletteNbt = NBT.ListTag<{
  Name: string, // block id
  Properties?: { [property: string]: string }
}>;

export type LitematicNbt = { // .litematic
  rootName: '',
  endian: 'big',
  compression: 'gzip',
  bedrockLevel: false
...
export type SchematicNbt = { // .schematic
  rootName: 'Schematic',
  endian: 'big',
  compression: 'gzip',
  bedrockLevel: false
